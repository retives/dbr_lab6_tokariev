...
def silver_order_items():
    return (
        dlt.read("bcomm_olist_order_items")
        .dropDuplicates()
        .drop("source", "ingestion_date")
...
def silver_customers():
    return (
        dlt.read("bcomm_olist_customers")
        .dropDuplicates()
        .drop("source", "ingestion_date")
...
def silver_order_reviews():
    return (
        dlt.read("bcomm_olist_order_reviews")
        .filter(
...
def silver_order_payments():
    return (
        dlt.read("bcomm_olist_order_payments")
        .dropDuplicates()
        .drop("source", "ingestion_date")
...
def silver_geolocation():
    return (
        dlt.read("bcomm_olist_geolocation")
        .dropDuplicates()
        .drop("source", "ingestion_date")
...
def silver_product_category_translation():
    return (
        dlt.read("bcomm_product_category_name_translation")
        .dropDuplicates()
        .drop("source", "ingestion_date")
    )
